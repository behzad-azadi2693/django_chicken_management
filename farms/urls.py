...
from .views import (
            ...
            create_vaccination,edit_vaccination,
            manufacturing_farm,manufacturing,create_manufacturing,
...
urlpatterns = [
    ...
    path('manufacturing/farm/<int:pk>/', manufacturing_farm, name='manufacturing_farm'),
    path('manufacturing/<int:pk>/', manufacturing, name='manufacturing'),
    ...
    path('losse/<int:pk>/', losse, name='loose'),
